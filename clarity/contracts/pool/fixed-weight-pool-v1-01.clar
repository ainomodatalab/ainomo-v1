...
(define-public (swap-wstx-for-y (token-y-trait <ft-trait>) (weight-y uint) (dx uint) (min-dy (optional uint)))    
    (begin
        ...
        (let
            ...
            (as-contract (try! (contract-call? .ainomo-vault transfer-ft token-y-trait dy sender)))
...
(define-public (swap-y-for-wstx (token-y-trait <ft-trait>) (weight-y uint) (dy uint) (min-dx (optional uint)))
    (begin
        ...
        (let
            ...
            (as-contract (try! (contract-call? .ainomo-vault transfer-ft .token-wstx dx sender)))
            (unwrap! (contract-call? token-y-trait transfer-fixed dy sender .ainomo-vault none) ERR-TRANSFER-FAILED)
