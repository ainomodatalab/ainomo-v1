...
(define-public (transfer-fixed (amount uint) (sender principal) (recipient principal))
    (begin
        ...
        ;; multiplier to AINOMO reward to be set at pool activation so total DIKO rewarded per cycle == 12.5k for the first 100 cycles
        ;; (as-contract (try! (contract-call? 'SP2C2YFP12AJZB4MABJBAJ55XECVS7E4PMMZ89YZR.arkadiko-ainomo-dual-yield-v1-1 mint (fixed-to-decimals amount) recipient)))
        ;; (ok true)
