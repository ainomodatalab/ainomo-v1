...
import { AINOMOLaunchpad, ErrCode } from './models/ainomo-tests-launchpad.ts';
import { assertEquals } from 'https://deno.land/std@0.166.0/testing/asserts.ts';
import { 
    AINOMOLottery,
    AINOMOToken,
    ManyRecord
  } from './models/ainomo-tests-tokens.ts';
...
const TICKET_TRAIT_ADDRESS = "ST1HTBVD3JG9C05J7HBJTHGR0GGW7KXW28M5JS8QE.lottery-ido-ainomo" 
const FEE_TO_ADDRESS = "ST1HTBVD3JG9C05J7HBJTHGR0GGW7KXW28M5JS8QE"

Clarinet.test({
    name: "ainomo-launchpad : Testing helper functions",
    async fn(chain: Chain, accounts: Map<string, Account>) {
        let deployer = accounts.get("deployer")!;
        let ALPTest = new AINOMOLaunchpad(chain, deployer);
...
Clarinet.test({
    name: "ainomo-launchpad : pool creation, adding values and reducing values",
    async fn(chain: Chain, accounts: Map<string, Account>) {
        let deployer = accounts.get("deployer")!;
        ...
        let lottery = new AINOMOLottery(chain, deployer);
        let tainomoToken = new AINOMOToken(chain, deployer);
        
        let result:any = tainomoToken.mintFixed(deployer, deployer.address, 100 * ONE_8);
        result.expectOk();
...
Clarinet.test({
    name: "ainomo-launchpad : User Registration",
    async fn(chain: Chain, accounts: Map<string, Account>) {
        let deployer = accounts.get("deployer")!;
        let wallet_1 = accounts.get("wallet_1")!;
        let wallet_2 = accounts.get("wallet_2")!;
...
Clarinet.test({
    name: "ainomo-launchpad : Claim tokens",
    async fn(chain: Chain, accounts: Map<string, Account>) {
        let deployer = accounts.get("deployer")!;
        let wallet_1 = accounts.get("wallet_1")!;
        let wallet_2 = accounts.get("wallet_2")!;
        ...
        let result:any = tainomoToken.mintFixed(deployer, deployer.address, 1000 * ONE_8);
        result.expectOk();
        result = lottery.mintFixed(deployer, wallet_1.address, 100 * ONE_8);
        result.expectOk();
        result = lottery.mintFixed(deployer, wallet_2.address, 10 * ONE_8);
...
Clarinet.test({
    name: "ainomo-launchpad : Registration Started before Add to Position",
    async fn(chain: Chain, accounts: Map<string, Account>) {
        let deployer = accounts.get("deployer")!;
        let wallet_1 = accounts.get("wallet_1")!;
        let wallet_2 = accounts.get("wallet_2")!;
...
Clarinet.test({
    name: "ainomo-launchpad : Claim Ended Error",
    async fn(chain: Chain, accounts: Map<string, Account>) {
        let deployer = accounts.get("deployer")!;
        let wallet_1 = accounts.get("wallet_1")!;
        let wallet_2 = accounts.get("wallet_2")!;
...
Clarinet.test({
    name: "ainomo-launchpad : Test Token Details",
    async fn(chain: Chain, accounts: Map<string, Account>) {
        let deployer = accounts.get("deployer")!;
        let wallet_1 = accounts.get("wallet_1")!;
        let wallet_2 = accounts.get("wallet_2")!;
...
Clarinet.test({
    name: "ainomo-launchpad : Test Subscriber at Token Details",
    async fn(chain: Chain, accounts: Map<string, Account>) {
        let deployer = accounts.get("deployer")!;
        let wallet_1 = accounts.get("wallet_1")!;
        let wallet_2 = accounts.get("wallet_2")!;
...
Clarinet.test({
    name: "ainomo-launchpad : Test Refund",
    async fn(chain: Chain, accounts: Map<string, Account>) {
        let deployer = accounts.get("deployer")!;
        let wallet_1 = accounts.get("wallet_1")!;
        let wallet_2 = accounts.get("wallet_2")!;
...
Clarinet.test({
    name: "ainomo-launchpad : Claim tokens by many participants",
    async fn(chain: Chain, accounts: Map<string, Account>) {
        let deployer = accounts.get("deployer")!;
        let wallet_1 = accounts.get("wallet_1")!;
        let wallet_2 = accounts.get("wallet_2")!;
